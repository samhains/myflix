...
south_park = Video.create!(
  title: 'South Park',
  description: 'A rude comedy series', 
  small_cover_url: '/tmp/south_park.jpg', 
  categories: [comedy])

family_guy = Video.create!(
  title: 'Family Guy',
  description: 'A family oriented comedy series', 
...
futurama = Video.create!(
  ...
  categories: [family, comedy, sci_fi])

monk = Video.create!(
  title: 'Monk',
  description: 'A detective series about a neurotic detective', 
...
monk = Video.create!(
  title: 'Monk',description: 'A dete
  ctive series about a neurotic detective', 
  small_cover_url: '/tmp/monk.jpg', 
  large_cover_url: 'tmp/monk_large.jpg', 
  categories: [drama, crime])
